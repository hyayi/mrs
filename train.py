...
from datamoules import BrainDataModule
import argparse
import yaml
import torch
import warnings
...
def train(args):
    ...
    model = getattr(lighthining_model, config['lighthining_model']['name'])(model_config=config['lighthining_model']['parmas'],class_weights=class_weights)
