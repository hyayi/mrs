...
def train(args):
    ...
    data_dm.setup()
    trainer.test(model, ckpt_path=checkpoint_callback.best_model_path, dataloaders = data_dm.test_dataloader())
...
if __name__=="__main__" :
    ...
    parser.add_argument("--config_path", type=str, default='config/nnunet/nnUnet_multi_feature_concat_test.yaml')
    parser.add_argument("--model_name", type=str, default='nn_test')
